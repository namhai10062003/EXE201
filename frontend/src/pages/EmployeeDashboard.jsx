...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        if (user) {
            setUserName(user.name); // Lưu tên người dùng vào state
        } else {
            // Nếu không có thông tin người dùng, điều hướng về trang login
            navigate('/login');
        }
    }, [navigate]);
        return (
            ...
            <header className="bg-white shadow-md">
              <div className="container mx-auto flex justify-between items-center py-4 px-6">
                ...
                <nav className="flex space-x-6">
                  ...
                  <a href="/meeting" className="text-gray-700 font-semibold">
                   Meeting
                  </a>
                  <a href="/doctors" className="text-gray-700 font-semibold">
                    Bác Sĩ
                  </a>
                  <a href="/bookingdoctor" className="text-gray-700 font-semibold">
                    Đặt Lịch
                  </a>
                </nav>
...
>
        <div className="dashboard">
            <h2>Xin chào, tôi là {userName || 'Người dùng'}</h2>
        </div>
</button>
<button className="bg-red-600 text-white px-4 py-2 rounded-full">
  ...
  <a href="/detail-nutri1" className="text-white">Nhận tư vấn</a>
</button>
            </div>
          </div>
          {/* Card 2 */}
          <div className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="p-4">
              ...
              <button className="bg-red-500 text-white px-4 py-2 rounded">
  <a href="/detail-nutri2" className="text-white">Nhận tư vấn</a>
</button>
            </div>  
          </div>
          {/* Card 3 */}
          <div className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="p-4">
              ...
              <button className="bg-red-500 text-white px-4 py-2 rounded">
  <a href="/detail-nutri3" className="text-white">Nhận tư vấn</a>
</button>
            </div>
          </div>
          {/* Card 4 */}
          <div className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="p-4">
              ...
              <button className="bg-red-500 text-white px-4 py-2 rounded">
  <a href="/detail-nutri4" className="text-white">Nhận tư vấn</a>
</button>
            </div>
          </div>
        </div>
